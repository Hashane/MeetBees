                            ...
                            GestureDetector(
                             onTap: (){
                              ...
                              child: Container(
                                ...
                                child:
                                _imageFile1 == null ?  new Icon(Icons.add,size: 16.0,color: Colors.white): Image.file(File(_imageFile1.path),fit: BoxFit.fill,),
                              ),
                            ),
                            GestureDetector(
                              onTap: (){
                              ...
                              child: Container(
                                color: Colors.black12,
                                child: _imageFile2 == null ?  new Icon(Icons.add,size: 16.0,color: Colors.white): Image.file(File(_imageFile2.path),fit: BoxFit.fill,),
                              ),
                            ),
                            GestureDetector(
                              onTap: (){
                              ...
                              child: Container(
                                color: Colors.black12,
                                child: _imageFile3 == null ?  new Icon(Icons.add,size: 16.0,color: Colors.white): Image.file(File(_imageFile3.path),fit: BoxFit.fill,),
                              ),
                            ),
                            GestureDetector(
                              onTap: (){
                              ...
                              child: Container(
                                color: Colors.black12,
                                child: _imageFile4 == null ?  new Icon(Icons.add,size: 16.0,color: Colors.white): Image.file(File(_imageFile4.path),fit: BoxFit.fill,),
                              ),
                            ),
                            GestureDetector(
                              onTap: (){
                              ...
                              child: Container(
                                color: Colors.black12,
                                child: _imageFile5 == null ?  new Icon(Icons.add,size: 16.0,color: Colors.white): Image.file(File(_imageFile5.path),fit: BoxFit.fill,),
                              ),
                            ),
                            GestureDetector(
                              onTap: (){
                              ...
                              child: Container(
                                color: Colors.black12,
                                child: _imageFile6 == null ?  new Icon(Icons.add,size: 16.0,color: Colors.white): Image.file(File(_imageFile6.path),fit: BoxFit.fill,),
                              ),
                            ),
                          ],
                        ),
